...
import { TabContent, TabPane, Nav, NavItem, NavLink, Row, Col, Form, FormGroup, FormText, Label, Input, Button } from 'reactstrap';
...
class FetchData extends Component {
    ...
    render() {
        return (
            <div>
                <h1>Channels</h1>
                <p>This component demonstrates functionality of the Channel REST API.</p>
                <hr />
                <Nav tabs>
                    <NavItem>
